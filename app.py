...
def build_prompt(data: dict, previous: str = None, feedback: str = None) -> str:
    ...
    return f"""لطفاً بر اساس اطلاعات زیر و همچنین محتوای فایلهای پیوست یک لایحه رسمی دادگاه به زبان فارسی و با ساختار استاندارد (عنوان، خطاب به دادگاه، شرح وقایع، دلایل و مستندات، استدلال حقوقی، و خواسته نهایی) تنظیم کن. لحن رسمی و موجز باشد و شماره‌گذاری منظم ارائه شود.
